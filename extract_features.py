...
def extract_and_save_index_features(dataset: Union[CIRRDataset, FashionIQDataset], clip_model: nn.Module,
    ...
    """
    Extract  fashionIQ features (with the respective names) from a dataset object and save them into a file
    ...
    items_processed = 0  # Counter for the number of items processed
    for names, images in tqdm(val_loader):
        if items_processed >= 11000:
            break  # Break out of the loop after processing 100 items
